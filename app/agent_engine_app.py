...
def _build_memory_service() -> Any:
    """Memory Bank si corremos en Agent Engine; in-memory en cualquier otro caso.

    Replica el auto-wiring del template AdkApp de vertexai (el camino que usaba
    el prototipo): la plataforma define GOOGLE_CLOUD_AGENT_ENGINE_ID en el
    contenedor. Sin un memory service, la tool load_memory del agente de
    rastreo lanza ValueError y tumba cada caso (LESSONS.md — Memory Bank).
    """
    ...
    def create(
        ...
        def create_runner() -> Runner:
            ...
            return Runner(
                ...
                memory_service=memory_service or _build_memory_service(),
            )
